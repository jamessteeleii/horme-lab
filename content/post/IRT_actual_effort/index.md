...
So we fit a simple linear model to estimate 1RM from *θ*<sub>*j*</sub>:
    ...
    ## Intercept   101.53      0.40   100.74   102.35 1.00     3760     2998
    ## theta         3.74      0.06     3.62     3.86 1.00     4012     2992
    ## 
    ## Family Specific Parameters: 
    ##       Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## sigma     4.05      0.30     3.52     4.69 1.00     3698     2922
    ## 
...
And also to estimate load from *β*<sub>*i*</sub>:
    ...
    ## Population-Level Effects: 
    ##           Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## Intercept   103.09      1.78    99.68   106.65 1.00     4038     2669
    ## beta          3.65      0.12     3.42     3.88 1.00     3712     2401
    ## 
    ## Family Specific Parameters: 
    ##       Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## sigma     7.97      1.45     5.70    11.31 1.00     3067     2685
    ## 
    ## Samples were drawn using sampling(NUTS). For each parameter, Bulk_ESS
    ## and Tail_ESS are effective sample size measures, and Rhat is the potential
    ## scale reduction factor on split chains (at convergence, Rhat = 1).
...
(*E*<sub>*A*(*j**i*, *I**R**T*)</sub>).
    ...
    ## 1    p001 103.3932   10      9.671814 1.238623 -23.9298683     106.1568
    ## 2    p001 103.3932   20     19.343628 1.238623 -23.9954071     106.1568
    ## 3    p001 103.3932   30     29.015442 1.238623 -16.8708684     106.1568
    ## 4    p001 103.3932   40     38.687256 1.238623 -16.8600385     106.1568
    ## 5    p001 103.3932   50     48.359070 1.238623 -16.8734065     106.1568
    ## 6    p001 103.3932   60     58.030884 1.238623 -13.2351741     106.1568
    ## 7    p001 103.3932   70     67.702698 1.238623 -10.1032062     106.1568
    ## 8    p001 103.3932   80     77.374512 1.238623  -6.3110224     106.1568
    ## 9    p001 103.3932   90     87.046326 1.238623  -3.8446757     106.1568
    ## 10   p001 103.3932  100     96.718140 1.238623  -0.3278689     106.1568
